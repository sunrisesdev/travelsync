import type { TSLineAppearance, TSMethod } from '@/traewelling-sdk/types/types';

export const FALLBACK_METHOD_APPEARANCES: Record<
  TSMethod,
  Partial<TSLineAppearance>
> = {
  bus: {
    accentColor: '#A3007C',
    background: '#A3007C',
...
export const LINE_APPEARANCE_OVERRIDES: [RegExp, Partial<TSLineAppearance>][] =
  [
    // [
